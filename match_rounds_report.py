...
def generate_match_rounds_report(riot_id, tag, profile_data, folder_path="."):
        ...
        <div class="container">
            <div class="summary-container">
                <div class="summary">
                    ...
                    ECO Rank : <span class="eco-rank"> {{ eco_rank }}</span><br>
                    Gold Spent : {{ total_gold_spent }}<br>
                    Rerolls Spent : {{ total_rerolls }}<br>
                </div>
                <div class="summary">
                    <strong>🔥 Performance 🔥</strong>
                    Repositions : {{ total_repositions }}<br>
    ...
    eco_rank = calculate_final_rank(match_data)
