...
def get_profile_data(riotname,tag):
    ...
    headers = {
        ...
        "cookie": "appmobaabgroup=A; appcfcountry=TH; ...",  # Replace with actual cookies
        "dnt": "1",
        "origin": "https://mobalytics.gg",
        "referer": "https://mobalytics.gg/tft/profile/th/beggy-3105/overview",
    ...
    # Debugging: Print the body content and URL
